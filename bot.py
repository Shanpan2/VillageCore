    ...
    <body>
      ...
      <main class="wrap">
        ...
        <section id="games">
          ...
          <p>UNO、7並べ、大富豪、ポーカー、オセロ、五目並べ、詰将棋、Ito、コードネーム、人狼、じゃんけん、おみくじ、ダイスに対応しています。</p>
          <div class="grid">
            <div class="tile"><strong>ゲームパネル</strong><code>/game</code> からUNO、7並べ、大富豪、ポーカー、オセロ、五目並べ、詰将棋、Ito、コードネーム、人狼を選べます。募集作成、参加、抜ける、開始、中止、ルール確認をボタンで操作できます。</div>
